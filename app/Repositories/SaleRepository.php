...
class SaleRepository extends BaseRepository
{
    ...
    public function storeSale($input): Sale
    {
        try {
            ...
            $search = ['{customer_name}', '{sales_id}', '{sales_date}', '{sales_amount}', '{paid_amount}','{due_amount}','{app_name}'];
            ...
            $replace = [$customer->name, $sale->reference_code, $sale->date,$sale->grand_total, $payAmount,$dueAmount, getSettingValue('company_name')];
