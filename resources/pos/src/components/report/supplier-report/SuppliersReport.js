...
const SuppliersReport = (props) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            selector: row => row.currency + ' ' + parseFloat(row.total_amount).toFixed(2),
...
const mapStateToProps = (state) => {
    const {isLoading, totalRecord, warehouses, frontSetting, allSupplierReport} = state;
    return {isLoading, totalRecord, warehouses, frontSetting, allSupplierReport}
};
