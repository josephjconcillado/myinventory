...
useEffect(() => {
    ...
    const columns = [
        ...
        },
        {
            ...
            selector: row => row.currency + ' ' + parseFloat(row.price).toFixed(2),
            sortField: 'price',
            sortable: false,
        },
        {
...
const mapStateToProps = (state) => {
    const {isLoading, totalRecord, frontSetting, dates, topSellingReport} = state;
    return {isLoading, totalRecord, frontSetting, dates, topSellingReport}
};
