...
const WarehouseReport = (props) => {
    const {warehouses, fetchAllWarehouses, fetchWarehouseReport, warehouseReportData} = props;
...
const mapStateToProps = (state) => {
    const {warehouses, warehouseReportData} = state;
    return {warehouses, warehouseReportData}
};
