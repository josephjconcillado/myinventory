...
const PurchaseReport = (props) => {
    const {
        ...
        suppliers,
        frontSetting,
        fetchFrontSetting, totalPurchaseReportExcel, dates
    } = props;
    ...
    const columns = [
        ...
        },
        {
            ...
            selector: row => row.currency + ' ' + parseFloat(row.due).toFixed(2),
            sortField: 'due',
            sortable: false,
        },
        {
...
const mapStateToProps = (state) => {
    const {purchases, dates, totalRecord, isLoading, warehouses, suppliers, frontSetting, fetchFrontSetting} = state;
    return {purchases, dates, totalRecord, isLoading, warehouses, suppliers, frontSetting, fetchFrontSetting}
};
