...
import {placeholderText, getFormattedMessage, decimalValidate, onFocusInput} from '../../shared/sharedMethod';
...
const SalesForm = (props) => {
    ...
    const [saleValue, setSaleValue] = useState({
        ...
        received_amount: 0,
        paid_amount: 0,
        status_id: {label: 'Received', value: 1},
        payment_status: {label: 'Unpaid', value: 2},
    ...
    useEffect(() => {
        if (singleSale && !isQuotation) {
            setSaleValue({
                ...
                payment_status: singleSale ? singleSale.payment_status : '',
    ...
    const onPaymentStatusChange = (obj) => {
        ...
        setSaleValue(input => ({...input, payment_type: {label: 'Cash', value: 1}}))
    };
                ...
                {/*<Form>*/}
                    <div className='row'>
                        ...
                        <div className='col-12'>
                            <ProductMainCalculation inputValues={saleValue} updateProducts={updateProducts} frontSetting={frontSetting}/>
                        </div>
                        ...
                        <div className='col-md-4'>
                            <ReactSelect name='status_id' data={status} onChange={onStatusChange}
                        ...
                        { !singleSale && <div className='col-md-4'>
                            <ReactSelect name='payment_status' data={paymentStatus} onChange={onPaymentStatusChange}
                        ...
                        { !singleSale && saleValue.payment_status.value !== 2 && <div className='col-md-4'>
                            <ReactSelect name='payment_type' data={paymentType} onChange={onPaymentTypeChange}
                        ...
                        { isQuotation && <div className='col-md-4'>
                            <ReactSelect name='payment_status' data={paymentStatus} onChange={onPaymentStatusChange}
                                         title={getFormattedMessage('dashboard.recentSales.paymentStatus.label')}
                                         value={saleValue.payment_status}  defaultValue={saleValue.payment_status} errors={errors['payment_status']}
                                         placeholder={placeholderText('sale.select.payment-status.placeholder')}
                            />
                        </div>}
                        {isQuotation && isPaymentType &&  <div className='col-md-4'>
                            <ReactSelect name='payment_type' data={paymentType} onChange={onPaymentTypeChange}
                                         title={getFormattedMessage('select.payment-type.label')}
                                         value={saleValue.payment_type} defaultValue={saleValue.payment_type} errors={errors['payment_type']}
                                         placeholder={placeholderText('sale.select.payment-type.placeholder')}
                            />
                        </div>}
                        <div className='mb-3'>
