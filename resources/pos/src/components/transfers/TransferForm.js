        ...
        <div className='card'>
            <div className='card-body'>
                ...
                <div className='row'>
                    ...
                    <div className='col-md-4 mb-3'>
                        <ReactSelect name='status' data={TransferStatusType} onChange={onStatusChange}
...
const mapStateToProps = (state) => {
    const {products, frontSetting} = state;
    return {customProducts: prepareTransferArray(products), products, frontSetting}
};
