...
const PurchaseReturnForm = (props) => {
    const { addPurchaseReturnData, id, editPurchaseReturn, customProducts, singlePurchase, warehouses, suppliers,
        fetchProductsByWarehouse, products, frontSetting
    } = props;
    ...
    const [purchaseValue, setPurchaseValue] = useState({
        ...
        status_id: singlePurchase ? singlePurchase.status_id : {label: 'Received', value: 1},
    });
                ...
                {/*<Form>*/}
                    <div className='row'>
                        ...
                        <div className='col-12'>
                            <ProductMainCalculation inputValues={purchaseValue} updateProducts={updateProducts} frontSetting={frontSetting}/>
                        </div>
                        <div className='col-md-4 mb-5'>
                            <label className='form-label'>
                        ...
                        <div className='col-md-4'>
                            <ReactSelect name='status' data={status} onChange={onStatusChange}
                                         title={getFormattedMessage('purchase.select.status.label')}
                                         defaultValue={purchaseValue.status_id} errors={errors['status_id']}
...
const mapStateToProps = (state) => {
    ...
    return {customProducts: preparePurchaseReturnArray(products), purchaseProducts, products, frontSetting, fetchAllProducts}
};
