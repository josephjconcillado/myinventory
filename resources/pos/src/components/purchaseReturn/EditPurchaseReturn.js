...
const EditPurchaseReturn = (props) => {
    ...
    const selectedStatus = purchaseReturn && purchaseReturn.attributes && purchaseReturn.attributes.status && status.filter((item) => item.value === purchaseReturn.attributes.status)
