...
const TodaySalePurchaseCount = (props) => {
    const {todaySalePurchaseCount, todayCount, frontSetting, config, allSalePurchase, fetchAllSalePurchaseCount} = props;
        ...
        <Row className='g-4'>
            <Col className='col-12 mb-4'>
                <Row>
                    ...
                    <Widget title={getFormattedMessage("sales-return.title")}
                    ...
                    <Widget title={getFormattedMessage("purchases.return.title")}
                    ...
                    <Widget title={getFormattedMessage("dashboard.widget.today-total-sales.label")}
                            onClick={() => onClick('app/sales', "manage_sale")}
                    ...
                    <Widget title={getFormattedMessage("dashboard.widget.today-payment-received.label")}
                            onClick={() => onClick('app/sales', "manage_sale")}
                    ...
                    <Widget title={getFormattedMessage("dashboard.widget.today-total-purchases.label")}
                            onClick={() => onClick('app/purchases', "manage_purchase")}
                    ...
                    <Widget title={getFormattedMessage("dashboard.widget.today-total-expense.label")}
...
const mapStateToProps = (state) => {
    const {todayCount,allSalePurchase, config} = state;
    return {todayCount,allSalePurchase, config}
};
