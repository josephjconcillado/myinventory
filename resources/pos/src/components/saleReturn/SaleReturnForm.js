...
import {decimalValidate, getFormattedMessage, placeholderText, onFocusInput} from '../../shared/sharedMethod';
...
const SaleReturnForm = (props) => {
    ...
    const statusOption = saleReturnStatus && saleReturnStatus.map((status) => {
        return {value: status.value, label: status.label}
    });

    const onWarehouseChange = (obj) => {
        setSaleReturnValue(inputs => ({...inputs, warehouse_id: obj}));
        setErrors('');
    };

    const onCustomerChange = (obj) => {
        setSaleReturnValue(inputs => ({...inputs, customer_id: obj}));
        setErrors('');
    };
    ...
    const onSubmit = (event) => {
        ...
        if (valid) {
            if (singleSale) {
                ...
                addSaleData(prepareFormData(saleReturnValue));
                    ...
                    <div className='row'>
                        ...
                        <div className='col-md-4 mb-5'>
                            <ReactSelect name='warehouse_id' data={warehouses} onChange={onWarehouseChange}
                                         ...
                                         defaultValue={saleReturnValue.warehouse_id} value={saleReturnValue.warehouse_id}
                        ...
                        <div className='col-md-4 mb-5'>
                            ...
                            <Select
                                ...
                                value={saleReturnValue.customer_id} onChange={onCustomerChange}
                                options={customerOption}
                            />
                            <span
                                className='text-danger d-block fw-400 fs-small mt-2'>{errors['customer_id'] ? errors['customer_id'] : null}</span>
                        </div>
                        <div className='mb-5'>
                            <label className='form-label'>
                        ...
                        <div className='col-md-4 mb-5'>
                            ...
                            <Select
                                ...
                                options={statusOption} onChange={onStatusChange} value={selectedStatus}
                            />
                            <span
