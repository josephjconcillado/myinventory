                            ...
                            <Form>
                                ...
                                <div className='col-lg-6 mb-3'>
                                        ...
                                        <input type='text' className="form-control"
                                               ...
                                               onChange={(e) => onChangeInput(e)} value={prefixesValue.purchasesReturn}/>
                                        <span className='text-danger d-block fw-400 fs-small mt-2'>
...
export default connect(mapStateToProps, {fetchSetting, fetchCurrencies, fetchCacheClear, fetchAllCustomer, fetchAllWarehouses, editSetting})(Prefixes);
