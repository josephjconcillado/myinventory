                ...
                <Table style={{"width": "68%", "marginTop": "30px", "marginLeft": "auto"}}>
                    ...
                    <tr style={{"width": "100%"}}>
                        ...
                        <td style={{
                            ...
                            {currency} {paymentPrint.subTotal ? paymentPrint.subTotal.toFixed(2) : '0.00'}
                        </td>
                    </tr>
                    <tr style={{"width": "100%"}}>
                        <td style={{
                        ...
                        <td style={{
                            ...
                            {currency} {paymentPrint.taxTotal ? paymentPrint.taxTotal.toFixed(2) : '0.00'} ({paymentPrint ? parseFloat(paymentPrint.tax).toFixed(2) : '0.00'} %)
                        </td>
                    </tr>
                    <tr style={{"width": "100%"}}>
                        <td style={{
                        ...
                        <td style={{
                            ...
                            {currency} {paymentPrint ? parseFloat(paymentPrint.discount).toFixed(2) : '0.00'}
                        </td>
                    </tr>
                    <tr style={{"width": "100%"}}>
                        <td style={{
                        ...
                        <td style={{
                            ...
                            {currency} {paymentPrint.grandTotal}
                        </td>
                    </tr>
                    </tbody>
                </Table>
