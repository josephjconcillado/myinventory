...
const ProductCartList = (props) => {
    ...
    return (
        <tr key={index} className='align-middle'>
            ...
            <td className="text-nowrap">{frontSetting.value && frontSetting.value.currency_symbol} {calculateProductCost(singleProduct).toFixed(2)}</td>
            <td className="text-nowrap">{frontSetting.value && frontSetting.value.currency_symbol} {((calculateProductCost(singleProduct)) * singleProduct.quantity).toFixed(2)}</td>
