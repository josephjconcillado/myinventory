...
import {getFormattedDate, getFormattedMessage} from '../sharedMethod';
                        ...
                        {allSalePayments && allSalePayments.length !== 0 && allSalePayments.map((item)=>{
                            return (
                                <tr className='align-middle'>
                                    ...
                                    <td>
                                        <Button type='button' title='Edit' variant='light' onClick={()=>onEditClick(item)}
                                                className='text-success btn-sm me-1'>
                                            <FontAwesomeIcon icon={faPencil}/>
                                        </Button>
                                        <Button type='button' title='Delete' variant='light'
