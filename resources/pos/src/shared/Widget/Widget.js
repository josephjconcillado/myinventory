...
import {formatAmount} from "../sharedMethod";

const Widget = (props) => {
    const {title, value, currency, icon, className, iconClass, onClick} = props;
        ...
        <div className="col-xxl-3 col-xl-4 col-sm-6 widget" onClick={onClick}>
            <div
                ...
                <div className="text-end text-white">
                    ...
                    >
                    <h2 className="fs-1-xxl fw-bolder text-white">{currency} {formatAmount(value)}</h2>
                    </OverlayTrigger>
